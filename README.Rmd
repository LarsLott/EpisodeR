...
* RELEASE: Academic Freedom Growth and Decline Episodes data set 16.0 is based on the V-Dem dataset v16. In the following years, updated *Academic Freedom Growth and Decline Episodes data set* will be provided once a year when updated V-Dem is published. 
